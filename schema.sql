...
**Plafonds** : ville hors cible → max 5. Prix > 550 k€ → max 6. Aucune info loyers ET aucune surface exploitable → max 4 (dossier inanalysable).
...
{
  "note": 8.5,
  "verdict": "OPPORTUNITE" | "A_CREUSER" | "MOYEN" | "ECARTER",
  "ville": "...",
  "quartier": "...",
  "prix": 433000,
  "nb_lots": 9,
  ...
  "justification": "2-3 phrases max : pourquoi cette note, en citant les chiffres clés.",
  "red_flags": ["...", "..."],
...
Seuils de verdict : ≥ 8 = OPPORTUNITE ; 6,5-7,9 = A_CREUSER ; 5-6,4 = MOYEN ; < 5 = ECARTER.
